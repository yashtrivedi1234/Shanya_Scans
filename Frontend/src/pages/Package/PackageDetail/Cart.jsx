  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-[#1F509A] to-[#3b76d0] text-white px-6 py-4 flex justify-between items-center rounded-t-xl">
        <h3 className="text-lg font-semibold text-white">{data?.packageName}</h3>
      ...
      <div className="px-6 py-4">
        <div className="flex items-center space-x-3">
          <span className="text-sm text-gray-400 line-through">₹{data?.packageRate}</span>
      ...
      <div className="px-6 py-4 space-y-3">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm text-gray-600">
            <b>{data?.parameterInclude            }</b> parameters included
          </span>
        </div>
        <div className="flex items-center space-x-2">
          <img

...
export default function AboutSanya() {
    ...
    <section>
      <div className=" py-8 sm:py-10 md:py-12  px-4 sm:px-6 lg:px-8 bg-white text-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto md:text-center text-start">
          ...
          <motion.h3
            className="text-md md:text-2xl  text-main font-semibold mt-2 tleading-relaxed text-left md:text-center w-full hyphens-auto"
          ...
          {/* Subheading */}
          <motion.p
   className="text-lg md:text-xl mt-5 text-gray-700 leading-relaxed text-justify w-full hyphens-auto"

            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3, duration: 0.8 }}
          >
            <span className="font-semibold text-yellow text-justify">Shanya Global Scanning and Research Pvt. Ltd</span> aims at achieving the highest level of excellence with quality results.
          ...
          <div className="mt-4 md:mt-8 grid sm:grid-cols-2 md:grid-cols-3 gap-6 text-left">
            {[
              ...
              { "title": "💊 Nuclear Medicine & Therapies", "desc": "Nuclear Medicine uses radioactive substances for diagnosis and treatment of diseases." },

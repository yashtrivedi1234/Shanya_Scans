...
const ServiceSubListPage = ({ state, isLoading }) => {
  ...
  return (
    <div>
      ...
      <div className=" mx-auto flex flex-col items-center justify-center container md:px-6 ">
          <div
            className={`grid gap-12 justify-center font-poppins  ${serviceDetails.length <= 2 ? "grid-cols-1 sm:grid-cols-2" : "sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full"
              }`}
          >
            {
                ...
                <div key={state._id} className="relative ">
                  ...
                  <div className="group bg-white rounded-xl shadow-lg overflow-hidden hover:scale-105 transition transform duration-300  relative z-10 min-h-[120px] flex flex-col justify-between cursor-pointer " onClick={() => {
                    ...
                    <div className="absolute inset-0 bg-blue-100 p-6 flex flex-col justify-center items-center text-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl">
                      <button
                        className="mt-4 px-4 py-2 bg-yellow text-gray-800 rounded-lg shadow transition"
                        onClick={() => {
...
export default ServiceSubListPage;

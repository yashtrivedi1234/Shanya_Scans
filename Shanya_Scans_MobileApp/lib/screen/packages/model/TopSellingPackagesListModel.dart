class TopSellingPackagesListModel {
  bool? success;
  String? message;
  Data? data;

  TopSellingPackagesListModel({this.success, this.message, this.data});

  TopSellingPackagesListModel.fromJson(Map<String, dynamic> json) {

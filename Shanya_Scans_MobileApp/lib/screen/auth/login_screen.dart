...
class _LoginScreenState extends State<LoginScreen> {
  // PageController ki zarurat nahi ab kyuki sirf ek hi form hai
  // final PageController _pageController = PageController();
  // int _currentPage = 0;

  // TabController bhi remove kar rahe hain
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    // Tab section completely removed
                    // _buildTabSection(),

                    // Ab direct OTP form dikha rahe hain
                    Padding(
                    ...
                    // Extra space bottom ke liye (optional, agar chaho to rakh sakte ho)
                    SizedBox(height: ResponsiveHelper.containerHeight(context, 8)),
                  ],
                ),
              ),
            ),
  ...
  /// ✅ Enhanced Top Section with Modern Design (unchanged)
  ...
  // Tab section method ko completely remove kar diya
...
/// ✅ Modern Curve Clipper (unchanged)

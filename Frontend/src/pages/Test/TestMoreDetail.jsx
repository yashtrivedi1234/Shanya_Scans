...
import Instruction from "./TestInstruction";
...
import SkeletonTestDetail from "./SkeletonDetail";
const features = [
...
const TestMoreDetail = () => {
  ...
  const fetchData = async () => {
    const response = await dispatch(fetchTestSpecificDetail(slug))
  }
  ...
  return (
    <section className="py-2 sm:py-4 lg:py-6 bg-gray-50">
      {loading ? <SkeletonTestDetail /> :
        <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden px-2">
          {/* Header Section */}
          <div className="bg-gradient-to-r from-[#1F509A] to-[#3b76d0] md:p-5 p-2 text-white  flex flex-col md:flex-row items-start justify-between">
            <div>
              {/* <h2 className="md:text-2xl text-xl font-bold text-white">{testSpecificDetail?.testDetailName}</h2> */}
              <h2 className="md:text-2xl text-xl font-bold text-white">
                {(testSpecificDetail?.testDetailName || "")
                  .split(" ")
            ...
            <div className=" flex flex-col  justify-between md:items-center items-start" >
              <div className="text-lg font-bold text-[#dfdbdb] text-center ">₹{testSpecificDetail?.testPrice}/- </div>
              <button className="bg-yellow text-gray-800 px-10 py-2 rounded-lg mt-2 md:mt-0" onClick={() =>handleClick(testSpecificDetail)}>Book Now</button>
            </div>
          ...
          <div className="lg:p-5 mt-4">
            ...
            <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              {[{ img: img1, title: "Parameter Included", value: testSpecificDetail?.paramterInclude },
              { img: img2, title: "Free", value: testSpecificDetail?.sampleCollection },
              { img: img3, title: "Free", value: testSpecificDetail?.reportConsuling },
            ...
            <div className="mt-5 lg:p-4 bg-gray-100 rounded-lg shadow-md">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 text-center">
                ...
                <div className="p-2 bg-white rounded-md shadow flex flex-col items-center text-xs gap-2">
                  ...
                  <p className="font-bold text-main">{testSpecificDetail?.reportTime}</p>
                </div>
                ...
                <div className="p-2 bg-white rounded-md shadow flex flex-col items-center text-xs gap-2">
                  ...
                  <p className="font-bold text-main">{testSpecificDetail?.fasting}</p>
                </div>
                ...
                <div className="p-2 bg-white rounded-md shadow flex flex-col items-center text-xs gap-2">
                  ...
                  <p className="font-bold text-main">{testSpecificDetail?.recommedFor}</p>
                </div>
                ...
                <div className="p-2 bg-white rounded-md shadow flex flex-col items-center text-xs gap-2">
                  ...
                  <p className="font-bold text-main">{testSpecificDetail?.age}</p>
                </div>
              </div>
            </div>


            <div className="relative z-10 flex lg:flex-row hidden  items-center justify-center gap-6 lg:p-8">
              {/* Background Overlay */}
              <div
              ...
              {/* Book Now Button */}
              <button className="bg-red-500 text-white px-12 py-4 rounded-[2rem] shadow-lg transition-all duration-300 hover:bg-red-600 hover:scale-105">
                Book Now
              </button>

              {/* Call Us Button */}
              <button className="bg-white text-black border border-red-500 px-12 py-4 rounded-[2rem] shadow-lg transition-all duration-300 hover:bg-red-500 hover:text-white hover:scale-105">
                Call Us
              </button>
            </div>
            ...
            ></div> */}
              ...
              <ServiceInstruction data={testSpecificDetail} />

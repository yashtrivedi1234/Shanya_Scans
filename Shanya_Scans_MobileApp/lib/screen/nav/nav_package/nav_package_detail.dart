                            ...
                            children: [
                                              ...
                                              children: [
                                                    ...
                                                    RichText(
                                                      text: TextSpan(
                                                        children: [
                                                          ...
                                                          TextSpan(
                                                            text: packageList.packageRate ?.toString() ?? packageList .packageDiscount  ?.toString() ??  "",
                                                            // Price Amount
                                                            style: AppTextStyles
                                                                .heading1(
                                                              context,
                                                ...
                                                InkWell(
                                                  onTap: () {
                                                    ...
                                                    OrderItem orderItem =
                                                        OrderItem( id: packageList .sId ?? "",
                                                            name: packageList.packageName.toString(),
                                                            category:  (packageList.packageCategory == null ||
                                                                packageList.packageCategory.toString().trim().isEmpty)
                                                                ? "package"
                                                                : packageList.packageCategory.toString().trim(), // ✅ TRIPLE CHECK
                                                            // category: packageList.packageCategory.toString() ?? "package",
                                                            orderType: "package",
                                                            price: double.parse(packageList.packageRate?.toString() ?? packageList.packageDiscount?.toString() ?? ""),
                                                            // price: double.parse(packageList.packageRate.toString()),
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      Text(
                                                        "Required",
                                                        maxLines: 1,
                                                        overflow: TextOverflow .ellipsis, // agar jyada lamba ho
                                                        style: AppTextStyles.heading1(
                                                            context,
                                                            overrideStyle: TextStyle(
                                                                color: AppColors
                              ...
                              Padding(
                                ...
                                child: _buildExpandableTestSections(
                                  ...
                                  packageName:
                                      packageList.packageName.toString(),
                                  packageOverView:
                                      packageList.packageOverview.toString(),
                                  packageRate: packageList.packageRate
                                          ?.toString() ??
                                      packageList.packageDiscount?.toString() ??
                                      "",
                                  packageCategory: (packageList.packageCategory == null ||
                                      packageList.packageCategory.toString().trim().isEmpty)
                                      ? "package"
                                      : packageList.packageCategory.toString().trim(), // ✅ SAFE
                                  // packageCategory:packageList.packageCategory.toString() ?? "package",
                              ...
                              _buildParameterTestSections(
                                parameters: packageList.packageParamterDetails
                                    .toString(),
                              ),
                              ResponsiveHelper.sizeBoxHeightSpace(context, 1),
                              ...
                              WhyChooseSection(
                                items: [
                                  WhyChooseItem(
                                    ...
                                    onTap: () =>
                                        print("Center of Excellence tapped!"),
                                  ),
                                  WhyChooseItem(
                                    icon: Icons.currency_rupee,
                                    title: "Affordable Pricing of Each Scan",
                                    onTap: () =>
                                        print("Affordable Pricing tapped!"),
                                  ),
                                  WhyChooseItem(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              // ✅ Safe category check
                              String safeCategory = (packageCategory.trim().isEmpty)
                                  ? "package"
                                  : packageCategory.trim();

                              print("✅ Final category being sent: $safeCategory");
                              ...
                              OrderItem orderItem = OrderItem(
                                  ...
                                  // category: (packageCategory.isEmpty) ? "package" : packageCategory, // ✅ FIX

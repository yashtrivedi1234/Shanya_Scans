class PathalogyScansListDetailModel {
  bool? success;
  String? message;
  Data? data;

  PathalogyScansListDetailModel({this.success, this.message, this.data});

  PathalogyScansListDetailModel.fromJson(Map<String, dynamic> json) {
